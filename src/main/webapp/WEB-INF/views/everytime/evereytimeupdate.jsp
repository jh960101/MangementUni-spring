    ...
    <div id="content">
        ...
        <input type="hidden" name="bo_no" value="${board.bo_no}"/>
            ...
            <div class="input-group mb-0" style="border-bottom: none;">
                <input type="text" class="form-control2" name="content"
                       placeholder="&nbsp;&nbsp;${board.content}" aria-label="Recipient's username"
                       aria-describedby="button-addon2">
            </div>
            ...
            <div class="form-controls-container">
                ...
                <div class="오른쪽정렬1">
                    <div class="form-check d-inline">
                        <input class="form-check-input" name="bo_status"
                               style="font-weight: bolder; border: 2px solid rgb(2, 76, 134)"
                               type="checkbox" value="Y" id="flexCheckDefault"> <label
