	...
	<div class="container" style="height: 1000px;">
		<div id="content" style="margin-top: 60px;">
			...
			<div class="list-group">
				<input type="text" id="Box" class="box" value="&nbsp;자유 게시판"
					readonly>
			</div>

			<div class="input-group mb-0" style="margin-top: 5px;">
				<input class="form-control" placeholder="새 게시글을 작성해주세요"
					aria-label="Recipient's username" aria-describedby="button-addon2"
					readonly>
				<button class="btn btn-outline-secondary" style="width: 100px;"
					type="button" id="button-addon2" onclick="location.href='etnew'">글작성
				</button>
			</div>
					...
					<a
						...
						<div style="display: flex; align-items: center;">
							<div style="padding: 1px; margin-right: 10px; font-size: 15px;">
								...
								<c:if test="${nowDate-prevDate-1 < 1}">
                            오늘
                        </c:if>
